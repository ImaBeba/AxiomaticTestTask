...
<head>
  ...
  <link href="<c:url value="/res/css/features.css"/>" rel="stylesheet">
</head>
<body>
...
<main>
  <div class="container px-4 py-5" id="featured-3">
    <h2 class="pb-2 border-bottom">АРМ менеджера по оформлению кредита</h2>
    <div class="row g-4 py-5 row-cols-1 row-cols-lg-3">
      ...
      <div class="feature col">
        ...
        <p>Просмотреть список всех клиентов</p>
        <a href="/clients" class="icon-link d-inline-flex align-items-center">
          Перейти
          <svg class="bi" width="1em" height="1em"><use xlink:href="#chevron-right"/></svg>
        </a>
      </div>
      <div class="feature col">
        <div class="feature-icon d-inline-flex align-items-center justify-content-center text-bg-primary bg-gradient fs-2 mb-3">
          <svg class="bi" width="1em" height="1em"><use xlink:href="#person-lines-fill"/></svg>
        </div>
        <h2>Список заявок</h2>
